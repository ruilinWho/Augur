...
- **当前优先级：** 研究任务 job 化；OpenAI/Gemini Deep Research 正式 API 接入；ChatGPT/Claude/Gemini 网页 Research 结果回流 Augur；Prompt 模板与未来 Skills；每股专属信源验证；反思/复盘闭环；催化日历 / 反证雷达；Tauri 桌面打包。
