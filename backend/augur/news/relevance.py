...
def _select_pending(limit: int, offset: int = 0) -> list[tuple[int, str, str, str]]:
    ...
    try:
        ...
        # 社媒前缀（X·/X2·/小红书·/Threads·/Reddit·/微信·）跳过判定：社媒 lane 在「知」里
        ...
        rows = conn.execute(
            ...
            "AND source NOT LIKE 'X·%' AND source NOT LIKE 'X2·%' "
            "AND source NOT LIKE '小红书·%' AND source NOT LIKE 'Threads·%' "
            "AND source NOT LIKE 'Reddit·%' AND source NOT LIKE '微信·%' "
