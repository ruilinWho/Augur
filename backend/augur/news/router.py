...
async def feed(limit: int = 60, category: str | None = None) -> list[dict]:
    """最近新闻条目（可按 category=markets/tech/world 过滤）。"""
    return await run_in_threadpool(service.recent_items, limit, category)
