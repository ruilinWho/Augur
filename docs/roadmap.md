...
- 🟡 **X 官方号——准备就绪（待主人配 key）**：调研定论 关键账号只活在 X、官方 API 官僚、Nitter 已死。**桥改选 twtapi**（原选 TwitterAPI.io 但需国际银行卡、主人办不了；twtapi 有免费试用+月付套餐可付）。「设置 · 论坛/新闻」留 `TWTAPI_KEY` 槽，适配器待接。见 ADR-0006 第 3 节 + ADR-0007 第 5 节。
